...
def get_df(dataset_id: str, x_session_id=None):
...
def create_project(dataset_id, x_session_id):
    print(dataset_id)
    id = uuid.uuid4()
    file_path = UPLOAD_DIR / f"{id}.pkl"
    df: pd.DataFrame = get_df(dataset_id, x_session_id)
